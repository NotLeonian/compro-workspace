...
def _outer_parentheses_wrap_whole_expr(text: str) -> bool:
    text = text.strip()
...
def _normalize_for_testcase_signal(s: str) -> str:
    s = _normalize_constraints(s)
    s = unicodedata.normalize("NFKC", s)
...
def _math_var_pattern(name: str) -> str:
